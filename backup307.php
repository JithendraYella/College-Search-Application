    ...
    <div class="container show-loaded">
        ...
        <div class="queryresult">
            ...
            If (!$conn){
                ...
                if (isset($_GET['name'])) {
                    $name = $_GET['name'];
					//$thisisit = "INSERT INTO temp1 SELECT UNIID FROM COLLEGE1 WHERE NAME LIKE \"%name%\" ";
                }
                ...
                $stid = oci_parse($conn, "SELECT * FROM COLLEGE1 WHERE UNIID IN (SELECT UNIID FROM COLLEGE1 WHERE NAME LIKE '%$name%')");
                oci_execute($stid);
